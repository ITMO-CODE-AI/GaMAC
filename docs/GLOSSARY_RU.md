...
Сторонние реализации алгоритмов оптимизации гиперпараметров, таких как Optuna, обычно на основе байесовской оптимизации.
...
[процесс оптимизации](GLOSSARY_RU.md#процесс-оптимизации) будет искать конфигурацию, максимизирующую [целевую меру](#целевая-мера).
