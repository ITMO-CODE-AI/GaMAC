...
<overview>
GaMAC это модуль на языке Python для автоматизированного машинного обучения задачам кластеризации. Проект был запущен в 2024 году Лабораторией Искусственного Интеллекта Факультета Информационных Технологий и Программирования Университета ИТМО, с тех пор мы в настоящее время работаем над этим проектом.
</overview>
